    ...
    <Fragment>
      ...
      <div className={classes.container}>
        ...
        <p className={classes.text}>
          ...
          داستان را به بهترین شکل روایت می‌کنیم. با الهام از آثار بزرگانی چون
          داوینچی، پیکاسو و میکل‌آنژ، ما به دنبال خلق زیبایی‌ای هستیم که در آن
          جزئیات کوچک با دقت و ظرافت اصلاح شوند تا به یک کلیت زیبا و هماهنگ
          برسیم. این متد، نوعی طراحی مینیمال است که در آن هر نقص صورت به
          طبیعی‌ترین شکل ممکن اصلاح می‌شود. هدف ما از متد نچرال اوت‌لاین،
          جوانسازی چهره و به تعویق انداختن پیری است. ما به زیبایی طبیعی و بدون
          اغراق معتقدیم و به کمک این متد، به دنبال آن هستیم که نه تنها چهره را
          جوان‌تر کنیم، بلکه آن را به شکلی طبیعی و متعادل‌تر به نمایش بگذاریم.
        </p>
        ...
        <p>
          ...
          طراحی می‌شود. این تجربه‌ی شخصی‌سازی شده، باعث می‌شود هر فرد با اطمینان
          از اینکه بهترین نسخه از خود را تجربه می‌کند، به ما مراجعه کند. این
          فلسفه برند، تعهد ما به دقت، ظرافت، هنر و اعتماد را نشان می‌دهد و
          بیانگر این است که هر فرد شایسته است تا با حفظ شخصیت و ویژگی‌های
          منحصربه‌فرد خود، زیباترین نسخه از خود را ببیند. ما با افتخار در خدمت
          شما هستیم تا این زیبایی طبیعی را به شما هدیه دهیم.
        </p>
      </div>
    </Fragment>
  );
